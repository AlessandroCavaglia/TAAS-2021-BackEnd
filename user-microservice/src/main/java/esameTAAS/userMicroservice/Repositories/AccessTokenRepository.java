...
public interface AccessTokenRepository extends JpaRepository<AccessToken,String> {
    ...
    @Query("SELECT U FROM PlatformUser U JOIN AccessToken T ON U.username = T.username WHERE T.token = :token")
    PlatformUser findUserByToken(@Param("token") String token);
